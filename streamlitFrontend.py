...
with st.sidebar:
    ...
    if "risk_score" in st.session_state and "risk_category" in st.session_state:
        ...
        st.write(f"Risk Category: {st.session_state['risk_category']}")
    ...
    if "optimized_weights1" in st.session_state and "optimized_weights2" in st.session_state and "optimized_weights3" in st.session_state:
        st.write("Optimized Portfolio Weights (High Risk):", st.session_state["optimized_weights1"])
        st.write("Optimized Portfolio Weights (Medium Risk):", st.session_state["optimized_weights2"])
        st.write("Optimized Portfolio Weights (Low Risk):", st.session_state["optimized_weights3"])
